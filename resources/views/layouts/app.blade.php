...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-black shadow-sm">
            <a class="navbar-brand pb-2 mb-1"><img src="{{ url('pictures/logo2.png') }}" alt="Not found"></a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown pr-5 mr-3">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle text-danger pr-5" href="#" role="button"
